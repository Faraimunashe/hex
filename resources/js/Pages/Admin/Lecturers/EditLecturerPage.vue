  ...
  <div class="p-6 min-h-screen bg-gray-100">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8 max-w-3xl mx-auto border border-blue-100">
      <h2 class="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
        <i class="fa fa-chalkboard-teacher text-blue-600"></i> Edit Lecturer
      </h2>
      ...
      <form @submit.prevent="submit" class="space-y-5">
        ...
        <div class="flex justify-end gap-2 pt-4">
          ...
          >
            ...
            <span v-if="!loading">Update Lecturer</span>
...
export default {
  ...
  data() {
    return {
      ...
      form: useForm({
        department_id: this.lecturer.department_id,
        firstnames: this.lecturer.firstnames,
        surname: this.lecturer.surname,
        gender: this.lecturer.gender,
        email: this.lecturer.user?.email || '',
        password: '',
      }),
    };
  },
  methods: {
    submit() {
      this.loading = true;
      this.form.put(`/admin/lecturers/${this.lecturer.id}`, {
        onSuccess: () => {
          this.snackbar.add({
            type: 'success',
